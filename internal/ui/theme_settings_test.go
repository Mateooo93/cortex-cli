...
func TestApplyConfiguredTheme_UsesStoredPrimaryAndDefaultSecondary(t *testing.T) {
	...
	if secondaryHex != config.DefaultThemeSecondary {
		t.Errorf("secondaryHex = %q, want default blue %q", secondaryHex, config.DefaultThemeSecondary)
	}
}